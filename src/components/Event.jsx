...
export default function Event(props) {
    ...
    if (props.eventName) {
        return (
            <div div className="max-w-[195px] min-w-[165px] flex flex-col gap-1 text-zinc-200 border-2 border-zinc-800 rounded-xl hover:border-zinc-700 hover:shadow-lg transition-all duration-300">

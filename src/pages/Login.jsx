        ...
        <form className='flex flex-col gap-4 items-center' onSubmit={handleSubmit}>
          ...
          <div className="flex flex-row gap-4 mt-3">
            ...
            <motion.button
              ...
              className={`gap-2 ${isLoading == null ? null : isLoading ? 'animation1' : 'animation2'} h-[41px] w-[132px] flex items-center px-4 py-2 text-green-400 bg-green-700/20 rounded-xl border border-green-900 hover:border-green-700 hover:shadow-lg transition-all duration-300`}
            >
              {isLoading ? (
                <motion.div
